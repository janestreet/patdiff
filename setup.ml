(* OASIS_START *)
(* DO NOT EDIT (digest: 1b8a161a842582ab3fdfd2de006d3630) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("patience_diff", None);
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\241\1924\011\012\170\230\228\r2\023\1545\179}\231";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
