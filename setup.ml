(* OASIS_START *)
(* DO NOT EDIT (digest: e1397acd84950075af0a53338a3ac91e) *)
(*
...
(* # 102 "/home/jdimino/.opam/4.00.1/build/oasis.0.3.0/src/oasis/OASISTypes.ml" *)
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$gzip", ["-c"; "patdiff.man"; ">"; "patdiff.1.gz"]))
                   ];
                 cmd_clean =
                   [(OASISExpr.EBool true, Some (("$rm", ["patdiff.1.gz"])))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/patdiff";
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Compare_core"; "Patdiff_core"; "Configuration"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "patdiff.ml"; });
               Doc
                 ({
                     cs_name = "patdiff_man";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "Man page for patdiff";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("patdiff.1.gz", None)];
                      doc_build_tools =
                        [
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\145\130A\159\146\219Y\184\223\167|\006\238\163\"\150";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
